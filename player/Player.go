...
func NewPlayerServiceClientFactory(t thrift.TTransport, f thrift.TProtocolFactory) *PlayerServiceClient {
  return &PlayerServiceClient{Transport: t,
    ProtocolFactory: f,
...
func (p *PlayerServiceClient) sendPing()(err error) {
...
func (p *PlayerServiceClient) sendUploadMap(gamemap [][]int32)(err error) {
  oprot := p.OutputProtocol
  if oprot == nil {
    oprot = p.ProtocolFactory.GetProtocol(p.Transport)
    p.OutputProtocol = oprot
...
func (p *PlayerServiceClient) sendUploadParamters(arguments *Args_)(err error) {
  oprot := p.OutputProtocol
  if oprot == nil {
    oprot = p.ProtocolFactory.GetProtocol(p.Transport)
    p.OutputProtocol = oprot
...
func (p *PlayerServiceClient) sendAssignTanks(tanks []int32)(err error) {
  oprot := p.OutputProtocol
  if oprot == nil {
    oprot = p.ProtocolFactory.GetProtocol(p.Transport)
    p.OutputProtocol = oprot
...
func (p *PlayerServiceClient) sendLatestState(state *GameState)(err error) {
  oprot := p.OutputProtocol
  if oprot == nil {
    oprot = p.ProtocolFactory.GetProtocol(p.Transport)
    p.OutputProtocol = oprot
...
func (p *PlayerServiceClient) sendGetNewOrders()(err error) {
  oprot := p.OutputProtocol
  if oprot == nil {
    oprot = p.ProtocolFactory.GetProtocol(p.Transport)
    p.OutputProtocol = oprot
...
func (p *PlayerServiceProcessor) ProcessorMap() map[string]thrift.TProcessorFunction {
  return p.processorMap
}

func NewPlayerServiceProcessor(handler PlayerService) *PlayerServiceProcessor {

  self14 := &PlayerServiceProcessor{handler:handler, processorMap:make(map[string]thrift.TProcessorFunction)}
  self14.processorMap["ping"] = &playerServiceProcessorPing{handler:handler}
  self14.processorMap["uploadMap"] = &playerServiceProcessorUploadMap{handler:handler}
  self14.processorMap["uploadParamters"] = &playerServiceProcessorUploadParamters{handler:handler}
  self14.processorMap["assignTanks"] = &playerServiceProcessorAssignTanks{handler:handler}
  self14.processorMap["latestState"] = &playerServiceProcessorLatestState{handler:handler}
  self14.processorMap["getNewOrders"] = &playerServiceProcessorGetNewOrders{handler:handler}
return self14
}
...
func (p *playerServiceProcessorPing) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := PlayerServicePingArgs{}
...
func (p *playerServiceProcessorUploadMap) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := PlayerServiceUploadMapArgs{}
  if err = args.Read(iprot); err != nil {
    iprot.ReadMessageEnd()
    x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
...
func (p *playerServiceProcessorUploadParamters) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := PlayerServiceUploadParamtersArgs{}
  if err = args.Read(iprot); err != nil {
    iprot.ReadMessageEnd()
    x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
...
func (p *playerServiceProcessorAssignTanks) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := PlayerServiceAssignTanksArgs{}
  if err = args.Read(iprot); err != nil {
    iprot.ReadMessageEnd()
    x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
...
func (p *playerServiceProcessorLatestState) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := PlayerServiceLatestStateArgs{}
  if err = args.Read(iprot); err != nil {
    iprot.ReadMessageEnd()
    x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
...
func (p *playerServiceProcessorGetNewOrders) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := PlayerServiceGetNewOrdersArgs{}
  if err = args.Read(iprot); err != nil {
    iprot.ReadMessageEnd()
    x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
